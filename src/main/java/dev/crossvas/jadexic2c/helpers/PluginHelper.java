...
//        tooltip.add(tooltip.getElementHelper().progress((float) current / max, Component.literal(text).withStyle(ChatFormatting.WHITE), new SpecialProgressStyle().color(color.aColor, color.bColor), new SpecialBoxStyle(color.back), true));
//    }
//
//    public static void bar(ITooltip tooltip, int current, int max, String text, ColorMix color) {
//        tooltip.add(tooltip.getElementHelper().progress((float) current / max, Component.translatable(text, current, max).withStyle(ChatFormatting.WHITE), new SpecialProgressStyle().color(color.aColor, color.bColor), new SpecialBoxStyle(color.back), true));
//    }
//
...
//        tooltip.add(tooltip.getElementHelper().progress((float) current / max, Component.translatable(text, current, max).withStyle(ChatFormatting.WHITE), new SpecialProgressStyle().color(color.mono, color.mono), new SpecialBoxStyle(color.back), true));
//    }
...
//    }
//
//    public static void textCentered(ITooltip tooltip, Component component) {
//        tooltip.add(new SpecialTextElement(component).centered());
//    }
//
...
//    }
//
//    public static void textCentered(ITooltip tooltip, String text, Object... args) {
//        tooltip.add(new SpecialTextElement(Component.translatable(text, args).withStyle(ChatFormatting.WHITE)));
//    }
//
