...
public enum RedirectorSlaveInfoProvider implements IHelper {
    INSTANCE;
    ...
    public void appendTooltip(ITooltip iTooltip, BlockAccessor blockAccessor, IPluginConfig iPluginConfig) {
        ...
        if (blockAccessor.getBlockEntity() instanceof RedirectorSlaveTileEntity slave) {
            ...
            if (blockEntity instanceof RedirectorMasterTileEntity master) {
                Helpers.text(iTooltip, "ic2.probe.redirector.slave.info", master.shares[slave.getFacing().getOpposite().get3DDataValue()]);
            }
