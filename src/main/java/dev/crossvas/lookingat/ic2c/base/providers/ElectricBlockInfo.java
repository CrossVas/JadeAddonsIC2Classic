    ...
    public void addInfo(IHelper helper, BlockEntity blockEntity, Player player) {
        if (blockEntity instanceof BaseElectricTileEntity baseTile) {
            ...
            if (baseTile instanceof CropMatronTileEntity cropmatron) {
                ...
                LookingAtCommonHandler.addTankInfo(helper, cropmatron);
            }
            ...
            if (baseTile instanceof MassFabricatorTileEntity massFab) {
                ...
                if (progress > 0) {
                    ...
                    bar(helper, progress, maxProgress, Component.translatable("ic2.probe.waila.progress",
                            Formatter.THERMAL_GEN.format(finalProgress)).append("%"), -4441721);
                }
