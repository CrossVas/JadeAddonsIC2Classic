...
public class ModNameRender {
    ...
    public static final ResourceLocation REMOVER = LookingAtIC2C.rl("remove_modid");
    public static final ResourceLocation RELOCATE = LookingAtIC2C.rl("relocate_modid");
