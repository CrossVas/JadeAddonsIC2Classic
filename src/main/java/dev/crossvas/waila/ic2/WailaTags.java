...
public class WailaTags {
    ...
    // info providers
    public static final ResourceLocation INFO_RENDERER = WailaIC2Classic.rl("renderer");
    public static final ResourceLocation WRENCHABLE = WailaIC2Classic.rl("wrenchable_info");
    public static final ResourceLocation TANK_RENDER = WailaIC2Classic.rl("remove_renders_fluid");
    // general config
    public static final ResourceLocation TOP_STYLE = WailaIC2Classic.rl("force_top_style");
