        ...
        if (blockEntity instanceof TileEntityBarrel) {
            ...
            Tuple STATUS;
                ...
                case 1:
                    ...
                    textCentered(helper, translatable("probe.barrel.status.storage.name").setChatStyle(new ChatStyle().setColor(EnumChatFormatting.YELLOW)));
                    ...
                    textCentered(helper, translatable("probe.barrel.status.brew.name").setChatStyle(new ChatStyle().setColor(EnumChatFormatting.YELLOW)));
