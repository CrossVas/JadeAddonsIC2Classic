...
public class ModNameRender {
    ...
    public static final ResourceLocation REMOVER = WailaIC2Classic.rl("remove_modid");
    public static final ResourceLocation RELOCATE = WailaIC2Classic.rl("relocate_modid");
