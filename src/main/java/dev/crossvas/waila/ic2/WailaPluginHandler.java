...
import dev.crossvas.waila.ic2.base.JadeTooltipRenderer;
import dev.crossvas.waila.ic2.base.removals.JadeTankInfoRenderer;
import dev.crossvas.waila.ic2.base.removals.ModNameRender;
...
@WailaPlugin(WailaIC2Classic.ID_IC2)
public class WailaPluginHandler implements IWailaPlugin {
    ...
    public void registerClient(IWailaClientRegistration registration) {
        registration.addConfig(WailaTags.TOP_STYLE, true);
            ...
            if (accessor instanceof BlockAccessor blockAccessor) {
                ...
                if (listener instanceof BlockEntity master) {
                    if (!(blockAccessor.getBlockEntity() instanceof BaseValveTileEntity)) { // we handle each valve individually for each multiblock
                        ...
                        blockAccessor.getServerData().put(WailaTags.TAG_STRUCTURE, structureTag);
